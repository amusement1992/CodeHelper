...
namespace CodeHelper
{
    ...
    public class Utils
    {
        ...
        {
            if (expression != null)
                return IsInt(expression.ToString());
        ...
        public static bool IsDecimal(string expression)
        {
            ...
            {
                decimal val;
                if (decimal.TryParse(expression, out val))
                {
                    return true;
                }
            }
        ...
        /// <returns>string</returns>
        public static string GetFilePrefix(string _filepath)
        {
            if (string.IsNullOrEmpty(_filepath))
            {
                return "";
            ...
            if (_filepath.LastIndexOf(".") > 0)
            {
                return _filepath.Substring(0, _filepath.LastIndexOf(".")); //文件扩展名，不含“.”
            }
            return "";
        }
        ...
        //{
        //    string result = CacheHelper.GetCache(key) as string;
        //    if (result == null)
        //    {
        ...
        //            result = "暂时无法连接!";
        //        }
        //        CacheHelper.SetCache(key, result, 60);
        //    }
        ...
        /// <param name="obj">要转换的对象</param>
        /// <returns>转换后的string类型结果</returns>
        public static string DateTimeToStr(DateTime obj)
        {
            return DateTimeToStr(obj, "yyyy-MM-dd");
        }
        ...
        public static string DateTimeToStr(DateTime? obj)
        {
            ...
            return DateTimeToStr((DateTime)obj, "yyyy-MM-dd");
        }
        ...
        /// <param name="obj">要转换的对象</param>
        /// <returns>转换后的string类型结果</returns>
        public static string DateTimeToStr2(DateTime obj)
        {
            return DateTimeToStr(obj, "yyyy-MM-dd HH:mm:ss");
        }
        ...
        public static string DateTimeToStr2(DateTime? obj)
        {
            ...
            return DateTimeToStr((DateTime)obj, "yyyy-MM-dd HH:mm:ss");
        }
        ...
        /// <param name="obj">要转换的对象</param>
        /// <returns>转换后的string类型结果</returns>
        public static string DateTimeToStr3(DateTime obj)
        {
            if (obj == null)
            {
                return null;
            }
            return DateTimeToStr(obj, "yyyy年MM月dd日");
        }
        ...
        public static string DateTimeToStr3(DateTime? obj)
        {
            ...
            return DateTimeToStr((DateTime)obj, "yyyy年MM月dd日");
        }
        ...
        /// <param name="obj">要转换的对象</param>
        /// <returns>转换后的string类型结果</returns>
        public static string DateTimeToStr4(DateTime obj)
        {
            return DateTimeToStr(obj, "yyyy/MM/dd");
        }
        ...
        /// <summary>
        /// 将日期转换为字符串 dd / MM / yyyy
        /// </summary>
        /// <param name="obj">要转换的对象</param>
        /// <returns>转换后的string类型结果</returns>
        public static string DateTimeToStr5(DateTime? obj)
        {
            if (obj.HasValue)
            {
                return DateTimeToStr((DateTime)obj, "dd / MM / yyyy");
            }
            return null;
        }
        ...
        /// <param name="obj">要转换的对象</param>
        /// <returns>转换后的string类型结果</returns>
        public static string DateTimeToStr(DateTime obj, string format)
        {
            if (obj == null)
                return "";
